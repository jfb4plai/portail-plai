...
const apps: AppItem[] = [
  ...
  },
  {
    id: 'jev-guide',
    audience: 'enseignant',
    name: 'Jev (TypeSafe) — Trier sans rédiger',
    description: "Comprendre Jev, le modèle qui renvoie un choix et un niveau de certitude au lieu d'un texte : ce qu'il peut apporter à vos applications et à la validation par RISS, ses limites (anglais, données), l'appel du skill et le bon moment pour la clé API.",
    url: '/guide-jev-plai.html',
    emoji: '🎯',
    category: 'Guide',
    status: 'disponible',
    color: 'teal',
        ...
        steps: [
          ...
          },
          {
            ...
            items: [
              ...
              "Chaque concept porte une priorité, Essentiel par défaut : repassez-le en Complémentaire pour qu'il soit proposé après les essentiels dans le parcours de l'apprenant et pèse moins dans l'alerte de remédiation du tableau de bord. Cela ne change ni la rigueur ni le niveau d'exigence des questions posées sur ce concept.",
              ...
              "Ce qui reste hors de votre contrôle : c'est l'IA qui décide, au fil de l'échange, qu'une notion est acquise — ce critère n'est pas paramétrable. Et sans curriculum défini, les notions proposées à l'apprenant sont extraites automatiquement des documents par l'IA, sans que vous en choisissiez le contenu ni l'ordre.",
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              "Suivi d'acquisition par notion : vue classe (thermomètre maîtrisée / avec indice / en cours / jamais abordée) et matrice notion × élève. Les concepts essentiels apparaissent en premier, les complémentaires sont repérables par leur étiquette « (complémentaire) ». La fiche par apprenant croise ses obstacles fonctionnels et ses notions acquises — pour l'accompagnement PLAI individuel.",
